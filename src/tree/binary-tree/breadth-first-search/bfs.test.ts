...
describe('Test bfs()', () => {
  ...
  it('Should_PerformBfsInRightOrder_WhenGivenBinaryTree', () => {
    ...
    expect(onVisited.mock.calls[0][0].value).toBe(50)
    expect(onVisited.mock.calls[1][0].value).toBe(25)
    expect(onVisited.mock.calls[2][0].value).toBe(75)
    expect(onVisited.mock.calls[3][0].value).toBe(10)
    expect(onVisited.mock.calls[4][0].value).toBe(33)
